...
class _TelaPlanetaState extends State<TelaPlaneta> {
  ...
  void initState() {
    ...
    _formatoController.text = _planeta.formato ?? '';
    _populacaoController.text = _planeta.populacao.toString();
    super.initState();
  }
            ...
            child: Column(
              children: [
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                      return 'Por favor, insira a população do planeta';
                    }
                    if (double.tryParse(value) == null) {
                      return 'Insira um valor numérico válido';
                    }
                  ...
                  onSaved: (value) {
                    _planeta.populacao = double.parse(value!);
                  },
                ),
